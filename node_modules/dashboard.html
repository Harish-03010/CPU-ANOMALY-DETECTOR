...
<head>
    ...
    <title>CPU Anomaly Detection Dashboard</title>
...
<body>
    ...
    <script>
        ...
        socket.on('connect', () => {
            ...
            document.getElementById('statusText').innerHTML = '<span class="pulse"></span>Connected - Monitoring CPU';
        });
        ...
        socket.on('cpu-data', (data) => {
            ...
            const cpuValue = data.cpu_usage.toFixed(2);
            ...
            // Update stats
            document.getElementById('currentCPU').textContent = cpuValue + '%';
